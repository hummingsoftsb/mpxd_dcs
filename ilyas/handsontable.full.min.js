 ...
 * Hacked by ilyas to enable some features like remarks on the rightmost column
 */
...
Handsontable.Core = function (rootElement, userSettings) {
  ...
  this.init = function () {
	...
	// Hacked to expose datamap
	this.exposed = {exposed: expose}//datamap: datamap};
...
//        instance.rootElement.addClass(settings.className);
  ...
  /** Hack by ilyas to get editor manager **/
...
//  instance.rootElement.addClass('handsontable');
  ...
  var walkontableConfig = {
    ...
    onScrollHorizontally: function () {
	  ...
	  //console.log("afterScrollHorizontally");
    },
...
// Hack so that HOT doesnt render for every row change, wait until changes finish then render at one shot.
	if (typeof window.dontRenderYet != 'undefined') {
		if (window.dontRenderYet) return;
	}
  if (!this.isWorkingOnClone()) {
 ...
 */
 ...
 // Hacked to not remove remarks column
WalkontableTableRenderer.prototype.adjustColumns = function (TR, desiredCount) {
  var count = TR.childNodes.length;
  var newDesiredCount = desiredCount;
  // Modify the desiredCount
  newDesiredCount = newDesiredCount + TR.getElementsByClassName("remarkdontremove").length;
 while (count < newDesiredCount) {
    var TD = document.createElement('TD');
    TR.appendChild(TD);
    count++;
  }
...
WalkontableTopOverlay.prototype.sumCellSizes = function (from, length) {
  var sum = 0;
  while (from < length) {
	//console.log("From",this.instance.wtTable.getRowHeight(from))
	//console.log("Default",this.instance.wtSettings.settings.defaultRowHeight)
