...
<script>
	$(document).ready(function()
	{
		...
		{
			var dataid = $('#editjournalno').val();
			$.post( "<?php echo base_url(); ?><?php echo $cpagename; ?>/close",{id:dataid}, function( data ) 
			{
				location.href="<?php echo base_url(); ?>designjournalnonp";
			});
		});
	});
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="modal-footer" style="text-align:center;border:0;">
							...
							<button type="button" class="btn btn-warning btn-sm" id="modalclose" name="modalclose">Close</button>
						</div>
					</form>
				</div>
			</div>
