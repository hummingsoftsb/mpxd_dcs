...
<html lang="en">
	...
	<body>
		<div id="wrap" style="height:100% !important;">
			<div class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					<!--HEADER-->
					<div class="navbar-header" style="position:relative;">
						<a href="#" class="navbar-brand">MPXD Data Capture System</a>
			...
			<!--TUTUP HEADER-->
			<div class="splash bground" style="height:100%;">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div><img class="logo" src="<?php echo base_url(); ?>/img/logo.png"></div>
							<h1>MRT Data Capture System</h1>
						</div>
					</div>
					<div class="row">
