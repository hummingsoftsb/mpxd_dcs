...
<div class="container">
	...
	<table class="table table-striped table-hover ">
    	<thead>
        	<tr>
            	<th>No</th>
	            <th><?php if ($searchrecord=="project_name asc")  { ?>
	            ...
	            <?php } ?></th>
	            <th><?php if ($searchrecord=="journal_name asc")  { ?>
	            ...
	            <!-- added by ilyas --> <th>Entry</th> <!-- end -->
	        </tr>
	    </thead>
    	<tbody>
    		<?php
			...
			?>
				<tr>
					...
					<?php  $pjdefdat=$pjdefreq[$pjde->journal_no]; ?>
					 ...
					 <!-- added by ilyas --> <td><a href="/ilyas?jid=<?php echo $pjde->journal_no;?>"><span class="glyphicon glyphicon-edit" style="color:red">&nbsp;</span></a></td> <!-- end -->
				</tr>
    		<?php
				$sno=$sno+1;
				endforeach;
