		...
		<table class="table table-striped table-hover">
    		...
    		<tbody>
				...
				?>
						<tr>
				  			<td><?php echo $sno; ?></td>
				  			<td><?php echo $record->data_attb_label; ?></td>
				  			<td><?php echo $record->data_attb_type_desc; ?></td>
	      					<td>
								<?php
									if($editperm==1)
									{
								?>
										<a href="#" data-toggle="modal" data-target="#myModal1" class="modaledit" data-attbid="<?php echo $record->data_attb_nonp_id; ?>" data-label="<?php echo $record->data_attb_nonp_label; ?>" data-attbtype="<?php echo $record->data_attb_nonp_type_id	; ?>" ><span class="glyphicon glyphicon-edit">&nbsp;</span></a>
								<?php
									}
									else
									{
		          			...
		          			<td>
								<?php
									...
									{
								?>
										<a href="#" data-toggle="modal" class="modaldelete" data-attbid="<?php echo $record->data_attb_nonp_id; ?>"><span class="glyphicon glyphicon-trash">&nbsp;</span></a>
								<?php
									}
									else
									{
