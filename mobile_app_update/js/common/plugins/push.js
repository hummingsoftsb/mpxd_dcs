(function(){
  ...
  function PushPlugin($q, $http, $ionicPlatform, $window, $log, PluginUtils, Config, $cordovaPush){
    var pluginName = 'Push';
	if (!$window.plugins) $window.plugins = {};
	if (!$window.plugins.pushNotification) $window.plugins.pushNotification = $cordovaPush;
